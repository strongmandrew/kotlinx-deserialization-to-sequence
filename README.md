...
Необходимо десериализовать только массив `loginHistory` и сделать это лениво (не десериализовывая сразу целиком `User`, предположим, в массиве 1_000_000 вхождений класса `LoginHistory`):
```json
{
  "login": "john-goodrow",
  "id": 25,
